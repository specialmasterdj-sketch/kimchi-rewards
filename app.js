...
(function(){
  ...
  const I18N = {
    ...
    dealsExpiring:  { en:'Quick-pick sale', es:'Oferta relámpago', ru:'Срочная распродажа', zh:'限时特价', ko:'임박 세일' },
    dealsExpSub:    { en:'Save big on items closing in.', es:'Aprovecha antes de que se acaben.', ru:'Большие скидки на товары с истекающим сроком.', zh:'临期商品大特价', ko:'유통기한 임박 — 할인 판매' },
